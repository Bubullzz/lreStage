...
import swhgraph_pb2 as swhgraph__pb2
...
class TraversalServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetNode = channel.unary_unary(
                ...
                request_serializer=swhgraph__pb2.GetNodeRequest.SerializeToString,
                response_deserializer=swhgraph__pb2.Node.FromString,
                )
        self.Traverse = channel.unary_stream(
                '/swh.graph.TraversalService/Traverse',
                request_serializer=swhgraph__pb2.TraversalRequest.SerializeToString,
                response_deserializer=swhgraph__pb2.Node.FromString,
                )
        self.FindPathTo = channel.unary_unary(
                '/swh.graph.TraversalService/FindPathTo',
                request_serializer=swhgraph__pb2.FindPathToRequest.SerializeToString,
                response_deserializer=swhgraph__pb2.Path.FromString,
                )
        self.FindPathBetween = channel.unary_unary(
                '/swh.graph.TraversalService/FindPathBetween',
                request_serializer=swhgraph__pb2.FindPathBetweenRequest.SerializeToString,
                response_deserializer=swhgraph__pb2.Path.FromString,
                )
        self.CountNodes = channel.unary_unary(
                '/swh.graph.TraversalService/CountNodes',
                request_serializer=swhgraph__pb2.TraversalRequest.SerializeToString,
                response_deserializer=swhgraph__pb2.CountResponse.FromString,
                )
        ...
        self.Stats = channel.unary_unary(
                ...
                request_serializer=swhgraph__pb2.StatsRequest.SerializeToString,
                response_deserializer=swhgraph__pb2.StatsResponse.FromString,
                )
...
def add_TraversalServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetNode': grpc.unary_unary_rpc_method_handler(
                    servicer.GetNode,
                    request_deserializer=swhgraph__pb2.GetNodeRequest.FromString,
                    response_serializer=swhgraph__pb2.Node.SerializeToString,
            ),
            'Traverse': grpc.unary_stream_rpc_method_handler(
                    servicer.Traverse,
                    request_deserializer=swhgraph__pb2.TraversalRequest.FromString,
                    response_serializer=swhgraph__pb2.Node.SerializeToString,
            ),
            'FindPathTo': grpc.unary_unary_rpc_method_handler(
                    servicer.FindPathTo,
                    request_deserializer=swhgraph__pb2.FindPathToRequest.FromString,
                    response_serializer=swhgraph__pb2.Path.SerializeToString,
            ),
            'FindPathBetween': grpc.unary_unary_rpc_method_handler(
                    servicer.FindPathBetween,
                    request_deserializer=swhgraph__pb2.FindPathBetweenRequest.FromString,
                    response_serializer=swhgraph__pb2.Path.SerializeToString,
            ),
            'CountNodes': grpc.unary_unary_rpc_method_handler(
                    servicer.CountNodes,
                    request_deserializer=swhgraph__pb2.TraversalRequest.FromString,
                    response_serializer=swhgraph__pb2.CountResponse.SerializeToString,
            ),
            ...
            'Stats': grpc.unary_unary_rpc_method_handler(
                    servicer.Stats,
                    request_deserializer=swhgraph__pb2.StatsRequest.FromString,
                    response_serializer=swhgraph__pb2.StatsResponse.SerializeToString,
            ),
    }
...
class TraversalService(object):
    ...
    def GetNode(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/swh.graph.TraversalService/GetNode',
            swhgraph__pb2.GetNodeRequest.SerializeToString,
            swhgraph__pb2.Node.FromString,
    ...
    def Traverse(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/swh.graph.TraversalService/Traverse',
            swhgraph__pb2.TraversalRequest.SerializeToString,
            swhgraph__pb2.Node.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def FindPathTo(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/swh.graph.TraversalService/FindPathTo',
            swhgraph__pb2.FindPathToRequest.SerializeToString,
            swhgraph__pb2.Path.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def FindPathBetween(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/swh.graph.TraversalService/FindPathBetween',
            swhgraph__pb2.FindPathBetweenRequest.SerializeToString,
            swhgraph__pb2.Path.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def CountNodes(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/swh.graph.TraversalService/CountNodes',
            swhgraph__pb2.TraversalRequest.SerializeToString,
            swhgraph__pb2.CountResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Stats(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/swh.graph.TraversalService/Stats',
            swhgraph__pb2.StatsRequest.SerializeToString,
            swhgraph__pb2.StatsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
